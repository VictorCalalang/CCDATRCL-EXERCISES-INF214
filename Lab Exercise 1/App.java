...
System.out.print("\n-----Weapon-----\n");
        ...
        Weapon sword = new Weapon("Lightbringer", 100, 1, "Epic", "A blade that burns down any ghoul enemy.");
        sword.weaponDescription();

        Weapon Scythe = new Weapon("Wicked Reach", 120, 4, "Mythic", "A Scythe that harvest souls on whom it slays.");
        Scythe.weaponDescription();

        Weapon Gun = new Weapon("Buck shot", 80, 2, "Uncommon", "A mini shotgun that fires heavy blows.");
